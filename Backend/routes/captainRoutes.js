...
router.post(
  ...
  [
    ...
    body("fullname.firstname")
        .isLength({ min: 3 })
      .withMessage("First name must be atleast 3 characters or long"),
    body("password")
      .isLength({ min: 6 })
      .withMessage("Password must be atleast 6 character or long"),
    body("vehicle.color")
      .isLength({ min: 3 })
      .withMessage("Colour must be atleast 3 characters"),
    body("vehicle.plate")
      .isLength({ min: 3 })
