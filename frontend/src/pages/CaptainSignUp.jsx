        ...
        <div>
          ...
          >
            ...
            <div className="flex gap-3 mb-5">
              <input
                required
                className="text-lg w-1/2 border-none py-2 rounded bg-[#eeeeee] placeholder:text-base mb-7 px-4"
                type="text"
            ...
            <div className="grid grid-cols-2 gap-4 p-3">
              <input
                required
                className="text-lg  w-full border-none py-2  rounded  bg-[#eeeeee] placeholder:text-sm px-4 mb-10"
                type="text"
              ...
              <input
                required
                className="text-lg  w-full border-none py-2  rounded  bg-[#eeeeee] placeholder:text-sm px-5 mb-10"
                type="text"
              ...
              <select
                required
                className="text-sm  w-full border-none py-2  rounded  bg-[#eeeeee] placeholder:text-sm px-2 mb-10"
                value={vehicleType}
                onChange={(e) => {
            ...
            <Link
              to="/captain-home"
              className="w-full bg-black text-white mt-2 border-none rounded py-2 font-semibold placeholder:text-base flex flex-col justify-center items-center mb-2 px-4 "
            >
          ...
          <div>
            <p className="text-[10px] leading-tight mt-[30%] p-5">
