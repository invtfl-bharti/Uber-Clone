...
const RidePopUp = (props) => {
  return (
    <div className="">
      ...
      >
        <i className="text-3xl mr-20 text-gray-200 ri-arrow-down-wide-line"></i>
      </h5>
      ...
      <div className="flex justify-between items-center flex-col gap-2">
        ...
        <div className="flex justify-start items-center gap-12">
          <button
            ...
            className="bg-gray-300 w-full px-6 py-2 font-semibold rounded-lg text-white text-lg mt-5"
          >
            Ignore
          </button>
          <button
            ...
            className="text-white
               w-full px-6 py-2 font-semibold rounded-lg bg-green-600 text-lg mt-5"
          >
            Accept
          </button>
        </div>
